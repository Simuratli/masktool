    ...
    return (
        <>
            ...
            <TutorialDropdown badge='For all field types' name='Rule 3. Custom'>
                <p className='tutorial__text'>
                    You can create your own masking rule (ex. for a phone number) by mixing data from lists and using additional requirements. <strong><span onClick={() => { dispatch(setStep('settings')) }} className="orange click">Click here</span></strong> to open custom rules settings.
                </p>
            </TutorialDropdown>

            <TutorialDropdown badge='For all field types' name='Rule 4. Clear'>
                <p className='tutorial__text'>
                    You can clear the data in selected fields if you are sure it does not impact further work with the system.
                </p>
                <p className='tutorial__text'>
                    <strong><span className="danger">Warning!</span></strong> You shouldn’t apply Clear Rule to the required fields as it will cause errors.
                </p>
            </TutorialDropdown>

            <TutorialDropdown badge='For dates' name='Rule 5. Range'>
                <p className='tutorial__text'>
            ...
            {/* <TutorialDropdown badge='For all field types' name='Rule 3. Custom'>
                <p className='tutorial__text'>
                    You can create your own masking rule (ex. for a phone number) by mixing data from lists and using additional requirements. <strong><span className="orange">Click here</span></strong> to open custom rules settings.
                </p>
            </TutorialDropdown> */}
